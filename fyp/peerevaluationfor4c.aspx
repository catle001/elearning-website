<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="peerevaluationfor4c.aspx.cs" Inherits="FYP.peerevaluationfor4c" %>
    ...
    <form id="form1" runat="server">
        ...
        <header>
                ...
                <ul class ="nav">
                    ...
                    <li><a class="current"><asp:Label ID="clabel4" Text="" runat="server" ></asp:Label></a></li>
