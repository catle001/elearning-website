<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master"
    CodeBehind="peerevaluationfor1c.aspx.cs" Inherits="FYP.peerevaluationfor1c" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <header>
                <nav>
                <ul class ="nav">
                    <li><a class="current"><asp:Label ID="clabel1" Text="" runat="server" ></asp:Label></a></li>
        ...
        <hr />
            <div class="style1">
             ...
             <div class="panel panel-default">
                ...
                <asp:Panel runat="server" ID="Panel1"><asp:Label runat="server" Text="" ID="Label1"></asp:Label>:
                    <center>
                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="rblhorizontal" RepeatColumns  ="5" RepeatLayout="Flow" RepeatDirection="Horizontal" TextAlign="Right">
    ...
    <asp:Panel runat="server" ID="q2panel">
            ...
            <hr />
                ...
                <asp:Panel runat="server" ID="Panel6"><asp:Label runat="server" Text="" ID="Label6"></asp:Label> :
                    <asp:RadioButtonList ID="RadioButtonList6" runat="server" CssClass="rblhorizontal" RepeatColumns  ="5" 
                        RepeatLayout="Flow" RepeatDirection="Horizontal" TextAlign="Right">
                        <asp:ListItem Text="" Value="5" style="margin-left:180px"></asp:ListItem> 
                        <asp:ListItem Text="" Value="4" style="margin-left:90px"></asp:ListItem>
                        <asp:ListItem Text="" Value="3" style="margin-left:90px"></asp:ListItem>
                        <asp:ListItem Text="" Value="2" style="margin-left:90px"></asp:ListItem>
    ...
    <asp:Panel runat="server" ID="q4panel">
            ...
            <br /></asp:Panel>
    <asp:Panel runat="server" ID="q5panel">
