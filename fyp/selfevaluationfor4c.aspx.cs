...
namespace FYP
{
    public partial class selfevaluationfor4c : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel4.Text + "' LIMIT 1";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel4.Text + "' LIMIT 2";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel4.Text + "' LIMIT 3";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel4.Text + "' LIMIT 4";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel4.Text + "' LIMIT 5";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel4.Text + "' LIMIT 6";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel4.Text + "' LIMIT 7";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel4.Text + "' LIMIT 8";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel4.Text + "' LIMIT 9";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel4.Text + "' LIMIT 10";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
        ...
        {
            submitRadio();
            Response.Redirect("selfevaluationfor5c.aspx");
        }
        private void submitRadio()
        {
                ...
                if (check == svr.Text)
                {
                    ...
                    conn.Open();
                    queryStr = "";
                    queryStr = "UPDATE selfevascore SET 4c ='" + RadioButtonList1.Text + "'+'" + RadioButtonList2.Text + "'+'" + RadioButtonList3.Text + "'+'" + RadioButtonList4.Text + "'+'" + RadioButtonList5.Text + "'+'" + RadioButtonList6.Text + "'+'" + RadioButtonList7.Text + "'+'" + RadioButtonList8.Text + "'+'" + RadioButtonList9.Text + "'+'" + RadioButtonList10.Text + "'WHERE StudentName = '" + svr.Text + "' ";
                ...
                else
                {
                    ...
                    conn.Open();
                    queryStr = "";
                    queryStr = "INSERT INTO selfevascore ( StudentName, 4c)" +
