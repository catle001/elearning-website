    <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selfevaluationfor4c.aspx.cs" Inherits="FYP.selfevaluationfor4c" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div style="width:100px; float:left; background:#b6ff00">
            ...
            <p style="font-size:20px"><asp:Label ID="clabel9" Text="" runat="server" backcolor="chartreuse"></asp:Label></p>
            <br />
        ...
        <header>
                ...
                <ul class ="nav">
                    ...
                    <li><a class="current"href="selfevaluationfor4c.aspx"><asp:Label ID="clabel4" Text="" runat="server" ></asp:Label></a></li>
