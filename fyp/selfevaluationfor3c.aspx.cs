...
namespace FYP
{
    public partial class selfevaluationfor3c : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel3.Text + "' LIMIT 1";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel3.Text + "' LIMIT 2";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel3.Text + "' LIMIT 3";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel3.Text + "' LIMIT 4";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel3.Text + "' LIMIT 5";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel3.Text + "' LIMIT 6";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel3.Text + "' LIMIT 7";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel3.Text + "' LIMIT 8";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel3.Text + "' LIMIT 9";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
            ...
            queryStr = "SELECT QuestionText FROM self_questions WHERE Competency LIKE '" + clabel3.Text + "' LIMIT 10";
            cmd = new MySql.Data.MySqlClient.MySqlCommand(queryStr, conn);
        ...
        {
            submitRadio();
            Response.Redirect("selfevaluationfor4c.aspx");
        }
