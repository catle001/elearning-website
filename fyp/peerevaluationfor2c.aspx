<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="peerevaluationfor2c.aspx.cs" Inherits="FYP.peerevaluationfor2c" %>
    ...
    <form id="form1" runat="server">
        ...
        <header>
                ...
                <ul class ="nav">
                    ...
                    <li><a class="current"><asp:Label ID="clabel2" Text="" runat="server" ></asp:Label></a></li>
