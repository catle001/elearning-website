<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="peerevaluationfor3c.aspx.cs" Inherits="FYP.peerevaluationfor3c" %>
    ...
    <form id="form1" runat="server">
        ...
        <header>
                ...
                <ul class ="nav">
                    ...
                    <li><a class="current"><asp:Label ID="clabel3" Text="" runat="server" ></asp:Label></a></li>
